...
<div
  class="d-flex justify-content-between justify-content-lg-end position-fixed top-0 right-0 p-3 bg-white w-100 shadow-sm"
  style="z-index: 10;">
  <button class="btn d-lg-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas-sidebar"
    aria-controls="offcanvas-sidebar">
    <i class="fa-solid fa-bars"></i>
  </button>

  <div class="offcanvas offcanvas-start bg-black  d-lg-none" tabindex="-1" id="offcanvas-sidebar"
      ...
      <ul class="nav flex-column">
        ...
        <li class="nav-item">
          <a href="./add-product.php" class="nav-link text-white">
            <i class="fa-solid fa-table-cells-large"></i> Products
          </a>
        </li>
        <li class="nav-item">
...
<section class="dashboard">
  <div class="container-fluid">
    <div class="row">
      <nav id="sidebar"
        class="col-md-3 col-lg-3 col-xl-2 d-lg-block bg-dark text-white vh-100 collapse sidebar sticky-top">
        <div class="sidebar-header p-3">
          <img src="<?php echo $Base_Url; ?>/assets/images/icons/vite.svg" alt="Logo" class="img-fluid">
        </div>
        <ul class="nav flex-column">
      ...
      <main class="col-12 ms-sm-auto col-lg-9 col-xl-10 px-md-4 my-5 pt-5">
...
<script type="module" src="<?php echo $Admin_Base_Url; ?>/assets/js/editOrderDetails.js"></script>
